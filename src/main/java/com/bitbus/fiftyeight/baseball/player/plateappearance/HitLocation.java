...
public enum HitLocation {
    ...
    BEHIND_HOME("Behind Home", false),
    FIRST_BASE("1B", false),
    WEAK_FIRST_BASE("Weak 1B", false),
    DEEP_FIRST_BASE("Deep 1B", false),
    SHORT_FIRST_BASE_LINE("Short 1B Line", false),
    FIRST_BASE_FOUL_TERRITORY("1B into Foul Terr.", false),
    SECOND_BASE_FIRST_BASE("2B-1B", false),
    WEAK_SECOND_BASE_FIRST_BASE("Weak 2B-1B", false),
    DEEP_SECOND_BASE_FIRST_BASE("Deep 2B-1B", false),
    SECOND_BASE("2B", false),
    WEAK_SECOND_BASE("Weak 2B", false),
    DEEP_SECOND_BASE("Deep 2B", false),
    SHORT_STOP_SECOND_BASE("SS-2B", false),
    WEAK_SHORT_STOP_SECOND("Weak SS-2B", false),
    DEEP_SHORT_STOP_SECOND_BASE("Deep SS-2B", false),
    SHORT_STOP("SS", false),
    WEAK_SHORT_STOP("Weak SS", false),
    DEEP_SHORT_STOP("Deep SS", false),
    THIRD_BASE_SHORT_STOP("SS-3B", false),
    WEAK_THIRD_BASE_SHORT_STOP("Weak SS-3B", false),
    DEEP_THIRD_BASE_SHORT_STOP("Deep SS-3B", false),
    THIRD_BASE("3B", false),
    WEAK_THIRD_BASE("Weak 3B", false),
    DEEP_THIRD_BASE("Deep 3B", false),
    SHORT_THIRD_BASE_LINE("Short 3B Line", false),
    THIRD_BASE_FOUL_TERRITORY("3B into Foul Terr.", true),
    PITCHER("P", false),
    PITCHERS_RIGHT("P's Right", false),
    PITCHERS_LEFT("P's Left", false),
